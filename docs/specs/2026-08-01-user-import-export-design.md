...
> 状态：✅ Phase 1 + Phase 2 已完成（2026-08-05，Task 0a-34 全部 ship，覆盖率 70.48%）/ ✅ v2.4 Task 35 Safety Gate 已完成（2026-08-07）/ ⚠️ v2.5 Task 35a 主实现完成、真实浏览器验收待补（2026-08-11 纠偏）/ ⚠️ Task 36 容量证据待实施 / ⚠️ 完整 Phase 3 明确推迟到 `ai-tool-gateway v1.5+` 重新评估，不建设异步任务基础设施 | 创建日期：2026-08-01 | v2 修订：2026-08-01 | v2.1 修订：2026-08-01 | v2.2 修订：2026-08-03（含 P1 二次细化） | v2.4 边界修订：2026-08-06 | v2.4 Safety Gate 实施：2026-08-07 | v2.5 确认编排修订：2026-08-07 | v2.5 主实现：2026-08-08 | v2.5 验收纠偏：2026-08-11
> 作者：Jack
...
- [ ] Task 35a **⚠️ 主实现完成，浏览器实跑验收 gap（2026-08-11 纠偏）**：按 ADR-0002 和 Gateway spec §4.7/§5.6/§8.8，用户导入已具备首个 `prepared + hitl + inline` 主链；确认 UI 由 Gateway 持久 action 驱动，不再依赖 Markdown 或 Prompt 触发。仓库已补三条确定性 Playwright 且 `--list` 通过，但本地 dev stack 未启动，实跑前不把 35a 标为完整 ship。
