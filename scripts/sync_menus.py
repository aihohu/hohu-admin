...
MENU_DEFINITIONS = [
    ...
    {
        "route_name": "system_user_batch-delete",
        "parent_route": "system_user",
        "menu_name": "用户批量删除",
        "menu_type": "F",
    ...
    {
        "route_name": "system_user_reset-password",
        "parent_route": "system_user",
        "menu_name": "重置密码",
        "menu_type": "F",
